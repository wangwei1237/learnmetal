...
class ColorTriangleViewController: UIViewController {
    //[[ properties
...
//        0.0,  0.5, 0.0,
    ...
    func initPipelineState() {
        ...
        let vertexFunc     = defaultLibrary?.makeFunction(name: "ct_basic_vertex")
        let fragmentFunc   = defaultLibrary?.makeFunction(name: "ct_basic_fragment")
